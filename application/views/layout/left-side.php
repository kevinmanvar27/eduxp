            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">                    
                   ...
                   <?php if(has_permission(VIEW, 'hrm', 'designation') || has_permission(VIEW, 'hrm', 'employee')){ ?>    
                    <li><a><i class="fa fa-user-plus"></i>  <?php echo $this->lang->line('human_resource'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <?php if(has_permission(VIEW, 'student', 'type') || 
                           ...
                           <li><a><i class="fas fa-user-check"></i> <?php echo $this->lang->line('manage_student'); ?> <span class="fa fa-chevron-down"></span></a>
                               <ul class="nav child_menu">
                                    <?php if(has_permission(VIEW, 'student', 'type')){ ?>
                ...
                <?php if(has_permission(VIEW, 'teacher', 'teacher') || 
                        ...
                        <li><a><i class="fa-solid fa-person-chalkboard"></i>
                        <?php echo $this->lang->line('teacher'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
