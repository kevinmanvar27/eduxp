    ...
    * ********************************************************** */
    private function _prepare_student_validation() {
        ...
        if (!$this->input->post('id')) {
            ...
            $this->form_validation->set_rules('roll_no', $this->lang->line('roll_no'), 'trim');          
        }
        ...
        $this->form_validation->set_rules('admission_no', $this->lang->line('admission_no'), 'trim');
        ...
        if ($this->input->post('is_guardian') == 'exist_guardian') {
            $this->form_validation->set_rules('guardian_id',  $this->lang->line('guardian_name'), 'trim');
        }
        
        if ($this->input->post('is_guardian') != 'exist_guardian' && !$this->input->post('id')) {
            $this->form_validation->set_rules('gud_username',   $this->lang->line('username'), 'trim');
            $this->form_validation->set_rules('gud_name',   $this->lang->line('name'), 'trim');
            $this->form_validation->set_rules('gud_phone',  $this->lang->line('phone'), 'trim');
        }
